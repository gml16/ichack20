...
async def start_onboarding(web_client: slack.WebClient, user_id: str, channel: str):
    ...
    onboarding_tutorials_sent[channel][user_id] = bot
...
async def update_emoji(**payload):
    ...
    bot = onboarding_tutorials_sent[channel_id][user_id]

    # Mark the reaction task as completed.
    bot.reaction_task_completed = True
    ...
    bot.timestamp = updated_message["ts"]
